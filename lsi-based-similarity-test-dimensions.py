...
def getSimilarityScores(data, tokenizer, stop_words, dim):
    ...
    #LSI similarity
    lsi = models.LsiModel(corpus, id2word=dictionary, num_topics=dim)
...
if __name__ == "__main__":
    ...
    for dim in dimensions:
        ...
        for dataset in datasets:
            scores = getSimilarityScores(dataset, tokenizer, stop_words, dim)
